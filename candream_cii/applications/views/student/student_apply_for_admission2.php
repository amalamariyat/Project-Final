	...
	<center>
        ...
        <?php echo form_open_multipart('Welcome/applyAdmission3') ?>
        <!-- <form method="" action=""> -->
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td><input type="date" required="date of birth" class="form-control" name="birth_date" min="1970-01-01" max="2002-12-31"></td>
            </tr>
