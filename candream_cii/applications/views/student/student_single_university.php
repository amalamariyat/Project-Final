  ...
  ?>
        <table class="table">
          <tr>
            ...
            <tr>
                <th data_validate="Required">More</th>
                <td><?php echo $university['remarks']; ?></td>
            </tr>
        </table>
