  ...
  $n=1; 
     foreach($consultancy->result() as $row)
        ...
        <figure class="snip1559">
          ...
          <figcaption>
            <h3><?php echo $row->cunsultancy_name; ?></h3>
            <h5><?php echo $row->phone; ?></h5>
            <p><?php echo $row->place; ?></p>
            <div class="icons"><a href=""></a>
              <a href="view_consultancy_by_id?id=<?php echo $row->cunsultancy_id ?>">View Consultancy </a><br>
              <a href="studentViewUniversity?c_name=<?php echo $row->cunsultancy_id ?>">View universities</a>
            </div>
          </figcaption>
        </figure --!>
