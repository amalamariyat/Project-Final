  ...
  <table>
    <tr>
      <th>Consultancy:</th>
      <td style=""><h2><?php echo $c_name; ?></h2></td>
    </tr><br>
  </table>
  ...
  $n=1; 
     foreach($university as $row)
        ...
        <figure class="snip1559">
          ...
          <figcaption>
            <h3><?php echo $row['university_name']; ?></h3>
            <h5><?php echo $row['place']; ?></h5>
            <p><?php echo $row['email']; ?></p>
            <div class="icons"></a>
              <a href="view_university_by_id?id=<?php echo $row['university_id'] ?>">View University </a><br>
              <a href="studentViewCourses?u_name=<?php echo $row['university_id'] ?>">View Courses</a>
            </div>
          </figcaption>
        </figure>
