   <section id="home" class="w3l-banner py-5">
    ...
    <h1>Student Applications</h1>
        <form method="post" action="" style="padding-top: 100px;" id=apply_form>
    ...
    <div class="container-fluid">
        <div class="row">
           <?php if ($add_status == null){
                ?>

            <div class="col-lg-3"></div>
            <div class="col-lg-3" style="padding: 15px;background: darkred;color: #fff;background-origin: padding-box;" >
                    <!-- <a href="<?php echo base_url().'index.php/Consultancycontroller/reject_app?id='.$admission_id; ?>" style="color: #fff;">Reject</a> -->
                     <p onclick="displayReason()" style="color: #fff;">Reject</p> 
                     <div id="reason_div" style="display:none;padding-top: 2rem;">
                      <form action="<?php echo base_url().'index.php/Consultancycontroller/reject_app'; ?>">
            ...
            <div class="col-lg-3" style="padding: 15px;background: green;color: #fff;">

                <a href="<?php echo base_url().'index.php/Consultancycontroller/accept_app?id='.$application_id; ?>" style="color: #fff;">Approve & Forward to University</a>
            </div>
            <div class="col-lg-3"></div>
            ...
            <div class="col-lg-3" style="padding: 15px;background: black;color: #fff;">

                <a  style="color: #fff;">Approve & Forward to University</a>
            </div>
            <div class="col-lg-3"></div>
