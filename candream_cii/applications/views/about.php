...
<body>
    ...
    <nav style="background-image: url(<?php echo $this->config->item('base_url').'assets/images/img4.jpg' ?>);" class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0 me-n3">
                <a href="<?=site_url('Welcome/index')?>" class="nav-item nav-link">Home</a>
                <a href="<?=site_url('Welcome/login')?>" class="nav-item nav-link">Login</a>
                <a href="<?=site_url('Welcome/about')?>" class="nav-item nav-link active">About</a>
    ...
    <div class="container-fluid bg-dark text-secondary p-5">
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="d-flex">
                    <a class="btn btn-lg btn-primary btn-lg-square rounded-circle me-2" href="errors/html/error_404.php"><i class="fab fa-twitter fw-normal"></i></a>
    ...
    <script src="<?php echo $this->config->item('base_url').'assets/lib/easing/easing.min.js'?>"></script>
    <script src="<?php echo $this->config->item('base_url').'assets/lib/waypoints/waypoints.min.js'?>"></script>
