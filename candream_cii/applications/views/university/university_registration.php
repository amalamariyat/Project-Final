...
<body>
    ...
    <center>
        <form method="post" action="<?=site_url('Universitycontroller/addUniversity')?>"  enctype="multipart/form-data">
            ...
            <tr>
                <th data_validate="Required" style="color: white">Area Code</th>
            ...
            <tr>
                ...
                <td><input type="tel" required="phone" class="form-control" name="phone" pattern="[1]{1}[0-9]{10}"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" required="password" class="form-control" name="website"></td>
            </tr>
            <tr>
            ...
            <tr>
                <th data_validate="Required" style="color: white">QS World University Ranking</th>
                <td><input type="number" required="rank" class="form-control" name="rank"></td>
            </tr>
            <tr>
                <th data_validate="Required" style="color: white">Password</th>
                <td><input type="password" required="password" class="form-control" name="password"></td>
            </tr>
            <tr>
                <th data_validate="Required" style="color: white">Confirm Password</th>
                <td><input type="password" required="confirm_password" class="form-control" name="confirm_password"></td>
            </tr>
             <tr>
                <th data_validate="Required" style="color: white">Documents</th>
                <td style="color: white">Upload Licence and other Documents in a single file.
                    <br>
                    Pdf Only !!!
                </td>
                <td><input style="color: white" type="file" required="file" name="licence" id="licence"></td>
            </tr>
            
                <td style="color: white"><input class="btn btn-info" type="submit" name="submit" ></td>
            </tr>
            </table>
    ...
    <script>
        ...
        function addCourses(){
          ...
          type: "POST",
          dataType: 'json',
          url: "<?php echo base_url(); ?>index.php/Universitycontroller/get_courses",
          
          success: function (data) {
            console.log(data);
                var no= $('#no_of_courses').val();
           no=parseInt(no);
           alert(no);
            document.getElementById('more_courses').innerHTML+=`
                <tr>
                    <td>   </td>
                     <td>
                        <select name="course_name_`+no+`" id="course_name_`+no+`">
                            <option>Select</option>

                        </select>
                    </td>
                     <td>
                        <input type="text" name="course_fee_`+no+`"  placeholder="Course fee">
                    </td>
                     <td>
                        <input type="text" name="course_duration_`+no+`"  placeholder="Course duration">
                    </td>
                </tr>
            `;
            data.forEach(myFunc);
              function myFunc(item, index){
                              ...
                              document.getElementById('course_name_'+no).innerHTML+=`
                                <option>
                                    `+item.course_name+`
                                </option>
                              `;
                            }
            document.getElementById('no_of_courses').value=no+1;
